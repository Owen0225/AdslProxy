...
# 拨号间隔，单位秒
DIAL_CYCLE = env.int('DIAL_CYCLE', 180)
# 延迟多久断开链接
DELAY_DISCON = env.int('DELAY_DISCON',60)
# 拨号出错重试间隔
DIAL_ERROR_CYCLE = env.int('DIAL_ERROR_CYCLE', 3)
# 拨号命令
...
# 测试URL
TEST_URL = env.str('TEST_URL', 'https://www.google.com/recaptcha/api.js')
# 测试最大失败次数
